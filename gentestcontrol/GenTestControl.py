...
_BUSNAME = "com.robosity.gentest.control"
_SERVICENAME = "/com/robosity/gentest/control"
...
class GenTestException(dbus.DBusException):
    def __init__(self, name, info):
        self._dbus_error_name = name
        self._info = info

class RhproControl(dbus.service.Object):
    def __init__(self):
    ...
    def run(self):
        ...
        try:
            ...
            syslog.syslog ("RhproControl service running...")
            self._loop.run()
            syslog.syslog ("RhproControl Service stopping...")

        except GenTestException as e:
        ...
        syslog.syslog ("GenTestControl Service stopped")
